...
class Client
{
    ...
    private function createCurlOptions($method, $body = null, $headers = null)
    {
        ...
        if (isset($headers)) {
            ...
            /**
             * BUGFIX: this section was erasing the $this->headers
             */
    ...
    public function makeRequest($method, $url, $body = null, $headers = null, $retryOnLimit = false)
    {
        ...
        /**
         * BUGFIX: the original implementation wasn't working;
         */
	    $response = curl_exec($curl); /** missing in the original implementation */
