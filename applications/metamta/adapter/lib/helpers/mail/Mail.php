...
class Personalization implements \JsonSerializable
{
    ...
    {
        /**
         * BUGFIX: this section had missing parts of JSON to form a valid
         * request to v3 API.
         * @see https://sendgrid.com/docs/API_Reference/Web_API_v3/Mail/errors.html#message.personalizations.to
         */
        if ($name !== null) {
                $this->tos[] = array("email" => $email, "name" => $name);
        } else {
                $this->tos[] = array("email" => $email);
        }
    }
